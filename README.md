...
- **Game Tab**: 
  - **Create Game**: Users can create a game by selecting the game type (Quick Match, Best of Three, Championship) and setting a stake in BSC testnet tBNB.
...
- **Blockchain**: All game states and transactions are recorded on the Ethereum BSC testnet network.
